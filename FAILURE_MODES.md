...
| API container crash | Kill API container/process | API becomes temporarily unavailable, then auto-recovers via Docker `restart: always` | Docker restarts container automatically | `scripts/chaos/02_api_restart_recovery.sh` |
